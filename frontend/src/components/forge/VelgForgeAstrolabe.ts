...
export class VelgForgeAstrolabe extends LitElement {
  ...
  private get _scanPhases(): string[] {
    return [
      ...
      msg('Deconstructing Paradox Layers'),
      msg('Measuring Existential Drift'),
      msg('Harvesting Semantic Residue'),
      msg('Correlating Mythopoetic Signatures'),
      msg('Stabilizing Narrative Waveform'),
      msg('Extracting Thematic DNA'),
      msg('Reconstructing Causal Threads'),
      msg('Evaluating Philosophical Density'),
      msg('Binding Conceptual Fragments'),
      msg('Projecting Anchor Resonance'),
      msg('Sealing Dimensional Breach'),
      msg('Committing Shard Topology'),
      msg('Unraveling Recursive Metaphors'),
      msg('Quantifying Symbolic Weight'),
      msg('Scanning Subconscious Archetypes'),
      msg('Weaving Narrative Scaffolding'),
      msg('Detecting Orphaned Plot Threads'),
      msg('Calibrating Irony Detectors'),
      msg('Mapping Allegory Networks'),
      msg('Compiling Philosophical Index'),
      msg('Stress-Testing Worldview Coherence'),
      msg('Encoding Mythic Resonance'),
      msg('Fusing Thematic Polarities'),
      msg('Validating Existential Parameters'),
      msg('Sealing Cognitive Lattice'),
