...
export const ARCHETYPES: readonly ArchetypeSlide[] = [
  ...
  },
  {
    ...
    quotes: [
      ...
      {
        text: 'The tower has crossed from architecture into archaeology. Every step forward is a step through what this building used to be.',
        author: 'Structural Banter',
      },
      {
  ...
  },
  {
    ...
    quotes: [
      {
        text: 'Your instruments read \u201cbiological hazard.\u201d Your body reads \u201chome.\u201d',
        author: 'Expedition Banter',
      },
      {
        text: 'The walls pulse. Gently. Like something breathing for you so you don\u2019t have to.',
        author: 'Expedition Banter',
      },
      {
        text: 'Something has prepared this room for you. The temperature is exact. The light is the color of afternoon through curtains.',
        author: 'Expedition Banter',
      },
      {
        text: 'You could stay. The thought arrives like warmth. Like something the air itself is suggesting.',
        author: 'Expedition Banter',
      },
      {
        text: 'The tissue on the walls reaches toward you. Not aggressively. The way a plant reaches toward light.',
        author: 'Expedition Banter',
      },
      {
        text: 'God help the organism that is wholly an island unto itself.',
        author: 'Octavia Butler, Lilith\u2019s Brood',
      },
    ],
  ...
  },
  {
    ...
    quotes: [
      ...
      {
        text: 'The corridor was here yesterday. Today it is mostly here.',
        author: 'Entropy Banter',
      },
      {
        text: 'The walls are not crumbling. They are agreeing with the floor.',
        author: 'Entropy Banter',
      },
      {
      ...
      {
        text: 'The instruments read accurately. The accuracy no longer means anything.',
        author: 'Entropy Banter',
      },
  ...
  },
  {
    ...
    quotes: [
      {
        text: 'I had desired it with an ardour that far exceeded moderation; but now that I had finished, the beauty of the dream vanished, and breathless horror and disgust filled my heart.',
      ...
      },
      {
        ...
        original:
          'Materia otrzyma\u0142a nieko\u0144czon\u0105 p\u0142odno\u015b\u0107, niewyczerpan\u0105 moc \u017cyciow\u0105 i zarazem uw\u00f3dczy si\u0142\u0119 pokusy, kt\u00f3ra nas nap\u0105 do formotworzenia.',
        originalLang: 'Polski',
      },
      {
      ...
      {
        text: 'Something in the crucible. Not what was intended. Better.',
        author: 'Workshop Banter',
      },
      {
        ...
        original:
          'W g\u0142\u0119bi materii kszta\u0142tuj\u0105 si\u0119 nie\u015bmia\u0142e u\u015bmiechy, napr\u0119\u017caj\u0105 si\u0119 napi\u0119cia, zbieraj\u0105 si\u0119 pr\u00f3by formy.',
        originalLang: 'Polski',
      },
      {
  ...
  },
  {
    ...
    quotes: [
      {
        text: 'The further south they moved, the more the biological clock within them reverted to a more primitive time.',
        author: 'J.G. Ballard, The Drowned World',
      },
      {
      ...
      {
        text: 'The sombre green-black fronds of the gymnosperms, intruders from the Triassic past, and the half-submerged white-faced buildings of the 20th century still reflected together in the dark mirror of the water.',
        author: 'J.G. Ballard, The Drowned World',
      },
      {
        text: 'Water is a mysterious element, a single molecule of which is very photogenic. It can convey movement and a sense of change and flux.',
        author: 'Andrei Tarkovsky',
      },
      {
        text: 'The earth is evil. We don\u2019t need to grieve for it.',
        author: 'Lars von Trier, Melancholia',
      },
    ],
    ...
    quotes: [
      {
        ...
        original:
          'Er sagte, ich behandle Gedanken, als ob ich sie selber erzeuge, aber seiner Ansicht nach seien Gedanken wie Tiere im Wald, oder Menschen in einem Zimmer, oder V\u00f6gel in der Luft.',
        originalLang: 'Deutsch',
      },
      {
      ...
      },
      {
        ...
        original:
          'L\u2019odeur et la saveur restent encore longtemps, comme des \u00e2mes, \u00e0 se rappeler, \u00e0 attendre, \u00e0 esp\u00e9rer, sur la ruine de tout le reste.',
        originalLang: 'Fran\u00e7ais',
      },
      {
        ...
        original:
          'Die Uhren stimmen nicht \u00fcberein, die innere jagt in einer teuflischen oder d\u00e4monischen oder jedenfalls unmenschlichen Art, die \u00e4u\u00dfere geht stockend ihren gew\u00f6hnlichen Gang. Was kann anderes geschehen, als da\u00df sich die zwei verschiedenen Welten trennen.',
        originalLang: 'Deutsch',
      },
      {
        ...
        original:
          'Schatten der Wirklichkeit sozusagen aus dem Nichts auf dem belichteten Papier hervortreten, gerade wie die Erinnerungen, die ja auch mitten in der Nacht in uns auftauchen und sich wieder verdunkeln, wenn man sie festzuhalten versucht.',
        originalLang: 'Deutsch',
      },
      {
        text: 'I am Ubik. Before the universe was, I am. I made the suns. I made the worlds. I am. I shall always be.',
  ...
  },
  {
    ...
    quotes: [
      {
        text: 'Starting from unlimited freedom, I conclude with unlimited despotism.',
      ...
      {
        text: 'Food is the first thing, morals follow on.',
      ...
      {
        text: 'Power is not a means; it is an end. One does not establish a dictatorship in order to safeguard a revolution; one makes the revolution in order to establish the dictatorship. The object of power is power.',
