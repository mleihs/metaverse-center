...
export function compoundLabel(name: string): string {
  switch (name) {
    case 'The Ruin':
      return msg('The Ruin');
    case 'The Crucible':
      return msg('The Crucible');
    case 'The Drowning':
      return msg('The Drowning');
    case 'The Erosion':
      return msg('The Erosion');
    case 'The Contagion':
      return msg('The Contagion');
    case 'The Disruption':
      return msg('The Disruption');
    case 'The Deluge Absolute':
      return msg('The Deluge Absolute');
    case 'The Awakened Throne':
      return msg('The Awakened Throne');
    default:
      return name;
  }
}
...
export function categoryLabel(category: string): string {
  switch (category) {
    case 'economic_crisis':
      return msg('Economic Crisis');
    case 'military_conflict':
      return msg('Military Conflict');
    case 'pandemic':
      return msg('Pandemic');
    case 'natural_disaster':
      return msg('Natural Disaster');
    case 'political_upheaval':
      return msg('Political Upheaval');
    case 'tech_breakthrough':
      return msg('Tech Breakthrough');
    case 'cultural_shift':
      return msg('Cultural Shift');
    case 'environmental_disaster':
      return msg('Environmental Disaster');
    default:
      return category;
  }
}
