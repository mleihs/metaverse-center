-- =============================================================================
-- SEED 011: Station Null — Deep Space Horror Simulation
-- =============================================================================
-- A derelict research station orbiting the black hole "Auge Gottes" (Eye of God).
-- Crew of 200 reduced to 6. Temporal anomalies, body horror, unreliable AI.
-- Lovecraft + Lem + Watts + VanderMeer + Event Horizon.
--
...
-- ---- Event Type (deep space horror themed) ----
INSERT INTO simulation_taxonomies (simulation_id, taxonomy_type, value, label, sort_order) VALUES
...
-- ---- Propaganda Type (re-themed as station communications) ----
INSERT INTO simulation_taxonomies (simulation_id, taxonomy_type, value, label, sort_order) VALUES
...
-- ============================================================================
-- 9. AI SETTINGS (Flux Dev + deep space horror style)
-- ============================================================================
...
-- Deep space horror style prompt for portraits
INSERT INTO simulation_settings (simulation_id, category, setting_key, setting_value)
...
-- Deep space horror style prompt for buildings
INSERT INTO simulation_settings (simulation_id, category, setting_key, setting_value)
...
-- Portrait description (EN) — deep space horror aesthetic
...
-- Building image description (EN) — deep space horror architecture
INSERT INTO prompt_templates (
    simulation_id, template_type, prompt_category, locale, template_name,
    prompt_content, system_prompt, variables, default_model,
    temperature, max_tokens, is_system_default, created_by_id
...
RAISE NOTICE 'Station Null seed complete: 1 simulation, 1 city, 4 zones, 16 streets, 6 agents, 7 buildings, 6 AI settings, 2 prompt templates';
END $$;
...
-- Verification
-- =============================================================================
SELECT 'simulation' as entity, count(*) as count FROM simulations WHERE id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'members', count(*) FROM simulation_members WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'taxonomies', count(*) FROM simulation_taxonomies WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'agents', count(*) FROM agents WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'buildings', count(*) FROM buildings WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'cities', count(*) FROM cities WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'zones', count(*) FROM zones WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'streets', count(*) FROM city_streets WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'settings', count(*) FROM simulation_settings WHERE simulation_id = '30000000-0000-0000-0000-000000000001'
UNION ALL
SELECT 'templates', count(*) FROM prompt_templates WHERE simulation_id = '30000000-0000-0000-0000-000000000001';
