-- Migration 112: Update fn_materialize_shard to insert _de columns from bilingual drafts.
--
-- The draft JSONB now contains _de fields (e.g. character_de, description_de) generated
-- bilingually by the AI. The RPC INSERT statements are updated to pass these through.
-- No new columns — _de columns already exist from migration 060.
