-- 058: Fix fn_materialize_shard
-- 1. Add SECURITY DEFINER so the function can INSERT into all tables
--    regardless of the calling user's RLS policies.
-- 2. Fix taxonomy singularization: rtrim('s') → regexp_replace for safety.
-- 3. Add building_condition to the buildings INSERT.
