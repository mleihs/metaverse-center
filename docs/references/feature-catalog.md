...
| F3 | **GA4 Analytics** | ✅ IMPL | 37 GA4-Events via deklarative EVENT_MAP (29 DOM-Events, 8 Service-Level). Production-Only Guard. Consent Mode v2. Measurement ID `G-WB8BSJ08KP`. |
