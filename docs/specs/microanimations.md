...
type: spec
status: active
tags: [animations, css, motion, entrance-effects]
---

# 23 — Dramatic Microanimations

**Related:** `../references/design-system.md` (base tokens), `theming-system.md` (ThemeService, animation_speed multiplier)
...
- **`../references/design-system.md`** — Base token definitions (spacing, colors, typography, borders, shadows, animation, layout, z-index)
- **`theming-system.md`** — ThemeService architecture, `animation_speed` multiplier, preset definitions, WCAG contrast validation
- **`embassies.md`** — Embassy card pulsing ring + gradient hover (pre-existing animation, not part of this spec)
