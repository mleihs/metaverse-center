...
type: spec
status: active
tags: [i18n, localization, xliff, lit-localize]
---
...
- **Frontend Components** (`../references/frontend-components.md`) - Komponenten die i18n nutzen
- **Simulation Settings** (`simulation-settings.md`) - Sprach-Settings pro Simulation
- **AI Integration** (`ai-integration.md`) - Prompt-Templates mit Locale
- **Techstack Recommendation** (`../explanations/techstack-recommendation.md`) - @lit/localize als i18n-Tool
