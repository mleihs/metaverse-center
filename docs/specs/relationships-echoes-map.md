---
title: "Relationships, Echoes & Map"
id: relationships-echoes-map
version: "1.1"
date: 2026-02-26
lang: de
type: spec
status: active
tags: [relationships, echoes, map, cross-simulation]
---
...
2. **Event Echoes** — The Bleed mechanic from `../explanations/concept-lore.md`. High-impact events create AI-transformed echoes in connected simulations, distorted through each world's aesthetic lens.
...
These features implement core concepts from `../explanations/concept-lore.md`:
