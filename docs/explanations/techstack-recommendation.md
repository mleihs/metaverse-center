---
title: "Techstack Recommendation"
id: techstack-recommendation
version: "1.5"
date: 2026-02-28
lang: de
type: explanation
status: active
tags: [techstack, dependencies, libraries]
---
...
# Hier Velgarien-Testdaten platzieren (aus Migration Strategy (`../guides/migration-strategy.md`) Phase 2)
```
...
- **Platform Architecture** (`../specs/platform-architecture.md`) - Architektur-Anforderungen die den Stack bestimmen
- **API Specification** (`../specs/api-specification.md`) - API-Endpoints (FastAPI-Routers)
- **Frontend Components** (`../references/frontend-components.md`) - Lit-Komponenten-Architektur
- **AI Integration** (`../specs/ai-integration.md`) - LangChain + OpenRouter Integration
- **Auth and Security** (`../specs/auth-and-security.md`) - Auth-Middleware via FastAPI Depends()
- **External Services** (`../specs/external-services.md`) - Async httpx für externe Services
- **Design System** (`../references/design-system.md`) - CSS-Token-System statt Tailwind
- **i18n Architecture** (`../specs/i18n-architecture.md`) - @lit/localize Integration
- **Migration Strategy** (`../guides/migration-strategy.md`) - Flask → FastAPI Migrationspfad
