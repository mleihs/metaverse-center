...
6. Design-Token-System (`../references/design-system.md`)
...
- **Database Schema Legacy** (`../archive/database-schema-legacy.md`) - Alt-Schema als Migrations-Quelle
- **Database Schema** (`../references/database-schema.md`) - Ziel-Schema
- **Domain Models** (`../references/domain-models.md`) - Entity-Definitionen
- **Simulation Settings** (`../specs/simulation-settings.md`) - Settings-Konfiguration
- **AI Integration** (`../specs/ai-integration.md`) - Prompt-Templates Migration
- **Auth and Security** (`../specs/auth-and-security.md`) - Auth + RLS Setup
- **Techstack Recommendation** (`../explanations/techstack-recommendation.md`) - FastAPI Stack-Empfehlung + Migrationspfad
- **i18n Architecture** (`../specs/i18n-architecture.md`) - i18n Implementation
...
### v1.1 (2026-02-15)
- Spaltenumbenennung gemaess Database Schema v2.0:
