...
- Migration 018: 19 anon SELECT policies (uses `deleted_at IS NULL`, table name corrections: `building_agent_relations`, `event_reactions`, no `agent_professions_junction`)
