...
| 4 | **B1-B3: Info Bubbles + UX** | ✅ High (communication) | Medium (6 components, ~80 lines) | A1+A2 must be real first | **IN PROGRESS** (2026-03-26). B3 DONE: Zone event risk display with RimWorld threshold markers + tier badges + actionable hints. B2 DONE: Building readiness factor pipeline (4-gauge Victoria 3 pattern, bottleneck indicator, influence tier badge). B1 pending: Agent influence panel redesign. |
