...
| 4 | **B1-B3: Info Bubbles + UX** | ✅ High (communication) | Medium (6 components, ~80 lines) | A1+A2 must be real first | **IN PROGRESS** (2026-03-26). Prerequisites met: A1+A2 deployed, 180 professions bootstrapped, all MVs live. Design research complete (Victoria 3 factor pipeline, RimWorld threshold markers, natural numbers pattern). Implementation: B1 agent influence tiers, B2 building readiness formula breakdown, B3 zone event risk display. |
