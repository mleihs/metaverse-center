...
- **Database Schema** (`../references/database-schema.md`) v2.0 — Renamed Spalten, neue Tabellen, Triggers, Views
- **Domain Models** (`../references/domain-models.md`) v2.0 — TypeScript Interfaces aligned mit Schema v2.0
- **Testing Strategy** (`testing-strategy.md`) — Test-Patterns, CI/CD, Coverage-Ziele
