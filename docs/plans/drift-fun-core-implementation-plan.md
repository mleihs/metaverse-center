...
- [ ] 1.2 Service/Router/Modelle: Payouts, EffectCards, /drift/profile
- [ ] 1.3 Migration 265 travel_havarie + fn_travel_havarie_resolve (+ Tests)
- [ ] 1.4 FE: DriftLedgerStrip, DriftEffectCards, DriftStoryletPanel (Havarie + Debriefing), M-01..M-04/M-15 (+ E2E)
- [ ] 1.5 Abschluss: Suite, Lints, Fresh-Eyes ×2, PR

**Welle 2 — feat/drift-fun-core-w2**
- [ ] 2.1 Signal-Pack (Schema + Loader + 32 Skelette + Seed-Migration 266a)
- [ ] 2.2 Migration 266 travel_signals: Draw in fn_travel_move, fn_signal_resolve, travel_log_entries, DZ-Eskalation (+ Tests)
- [ ] 2.3 Migration 267 travel_sondierung: fn_sondieren, haul_banked-Split, fn_funkboje_bank (+ Tests)
...
**Welle 3 — feat/drift-fun-core-w3**
- [ ] 3.1 Migration 268 drift_chart_v3 + Generator-Invarianten + Tuning v2 (Fenster 14 / BB 10 / DZ 40) (+ Tests)
- [ ] 3.2 Migration 269 travel_umstimmung + Permeabilität (+ Tests)
- [ ] 3.3 Migration 270 travel_requisition + Überlast (+ Tests)
- [ ] 3.4 Migration 271 travel_building_docks + Bond-/Investigate-/Tagesdepesche (+ Tests)
