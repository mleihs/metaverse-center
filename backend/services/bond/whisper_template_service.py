...
_TEMPLATES: list[WhisperTemplate] = [
    ...
    _t(
        ...
        "I arranged my tools today. Twice. There was nothing else to do, and idleness has a weight I cannot name.",
        mood=(-100, -20),
        tags=("boredom", "low_stimulation"),
    ),
    _t(
        "state",
        1,
    ...
    _t(
        ...
        "A smell stopped me this morning. Fresh-cut wood. I stood for a full minute breathing before I knew why.",
        mood=(-10, 50),
        tags=("memory_sense", "stillness"),
    ),
    _t(
        "state",
        1,
        ...
        "I have realized I clench my fists in sleep. The marks of my nails tell stories my mouth keeps silent.",
        stress=(400, 1000),
        tags=("tension", "suppression"),
    ),
    _t(
        "state",
        1,
        ...
        "A good day. Not happy, not peaceful – good in the sense that nothing broke that I could not mend.",
        mood=(0, 40),
        tags=("resilience", "ordinary_grace"),
    ),
    _t(
        "state",
        1,
    ...
    _t(
        ...
        mood=(-80, -10),
        tags=("isolation_deep", "inner_dialogue"),
    ),
    _t(
        "state",
        2,
        ...
        mood=(30, 100),
        tags=("spontaneous_joy", "body_wisdom"),
    ),
    # ═══════════════════════════════════════════════════════════════════════
    ...
    _t(
        ...
        mood=(0, 80),
        tags=("connection", "small_kindness"),
    ),
    _t(
        "event",
        1,
        ...
        "The well in {zone_name} runs with water again. Such a small sound, but the whole quarter pauses and listens.",
    ...
    _t(
        ...
        mood=(10, 100),
        tags=("communion", "spontaneous_gathering"),
    ),
    # ═══════════════════════════════════════════════════════════════════════
    ...
    _t(
        "memory",
        2,
        "Ich habe hier einen Rhythmus gefunden. Er ist leise. Ich habe aufgehört, Stille für Leere zu halten.",
        "I have found a rhythm here. It is quiet. I have stopped mistaking silence for emptiness.",
    ...
    _t(
        ...
        "Art von Käfig.",
        "I finished every task. Then again, differently. At some point, competence becomes its own kind of cage.",
    ...
    _t(
        "question",
        3,
        "Meine Hände zittern manchmal. Nicht vor Angst – vor Untätigkeit. Der Körper merkt sich, dass er mehr konnte.",
        "My hands tremble sometimes. Not from fear – from idleness. The body remembers it was capable of more.",
    ...
    _t(
        ...
        "You come back. That is the thing I notice most. Every time, you come back. Not everyone does. Not even most.",
...
class WhisperTemplateService:
    ...
    def select_template(
        ...
        if not filtered:
            ...
            filtered = [t_item for t_item in candidates if t_item.min_depth <= bond_depth]
