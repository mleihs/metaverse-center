...
MOTHER_LOOT_TIER_1: list[LootItem] = [
    ...
    LootItem(
        ...
        description_en=(
            "A shard that radiates warmth. It resists the Mother's emotional pull. Propagandist checks +5%."
        ),
        description_de=(
            "Ein Splitter, der Wärme abstrahlt. Er widersteht dem emotionalen Sog der Mutter. Propagandist-Proben +5%."
        ),
        drop_weight=25,
    ),
    LootItem(
...
DELUGE_LOOT_TIER_2: list[LootItem] = [
    ...
    LootItem(
        ...
        description_de=(
            "Ein Fragment der Sperre, die 200 Jahre hielt. Auf Sabotage angewandt, die Teilchenphysik des Widerstands."
        ),
        drop_weight=25,
    ),
    LootItem(
...
AWAKENING_LOOT_TIER_2: list[LootItem] = [
    ...
    LootItem(
        ...
        description_en=(
            "Thoughts are like animals in the forest \u2013 not generated by the thinker. Propagandist checks +10%."
        ),
        description_de=("Gedanken sind wie Tiere im Wald \u2013 nicht vom Denker erzeugt. Propagandist-Proben +10%."),
        drop_weight=25,
    ),
    LootItem(
...
OVERTHROW_LOOT_TIER_1: list[LootItem] = [
    ...
    LootItem(
        ...
        description_en=("Squealer's latest revision. The words are wrong but the technique is instructive."),
        description_de=("Schwatzwutz' neueste Überarbeitung. Die Worte sind falsch, aber die Technik ist lehrreich."),
        drop_weight=30,
    ),
    LootItem(
        ...
        description_en=(
            "A list of names. Some are informers. Some are targets. The difference is a matter of perspective."
        ),
        description_de=(
    ...
    LootItem(
        ...
        description_en=(
            "Signed by a faction leader. Valid until the faction leader is replaced. Which could be any moment."
        ),
        description_de=(
...
OVERTHROW_LOOT_TIER_3: list[LootItem] = [
    LootItem(
        ...
        description_en=(
            "Spec loot: upgrades one zone's security_level by 1 tier for 10 heartbeat ticks. Authority, portable."
        ),
        description_de=(
