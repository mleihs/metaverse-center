"""Generate all 13 images for the Speranza simulation.
...
`supabase start` fresh, IDs will change. Query the DB to get current IDs:
  docker exec supabase_db_velgarien-rebuild psql -U postgres -c \
    "SELECT id, name FROM agents WHERE simulation_id = '40000000-0000-0000-0000-000000000001';"
"""
...
SIM_ID = "40000000-0000-0000-0000-000000000001"
...
def main():
    ...
    print("=== Speranza Image Generation ===\n")
