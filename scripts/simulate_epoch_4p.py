...
def game_01(token):
    ...
    return finish_game(
        ...
        admin,
        players,
        "G1: Fortress vs Blitz",
        "V=6 guardians (turtle), GR=0 guardians (glass cannon), SN/SP=2 each",
        TAGS_4,
    )
...
def game_02(token):
    ...
    return finish_game(
        ...
        players,
        "G2: Balanced",
        "All players: 2 guardians, rotating saboteur/propagandist/spy",
        TAGS_4,
    )
...
def game_03(token):
    ...
    return finish_game(
        ...
        players,
        "G3: Warmonger",
        "Military=40% weight, 1 guardian each, alternating assassin/saboteur",
        TAGS_4,
    )
...
def game_04(token):
    ...
    return finish_game(
        ...
        players,
        "G4: Alliance War 2v2",
        "V+GR vs SN+SP, focused fire on opposing alliance",
        TAGS_4,
    )
...
def game_05(token):
    ...
    ctx = reset_game_state()
    epoch_id, players, admin = setup_game(
        ctx, token, "G5: Betrayal", BASE_CONFIG, TAGS_4, alliances={"Pact of Shadows": ("SN", "SP")}
    )
    last = run_foundation(ctx, epoch_id, players, admin, {"V": 2, "GR": 2, "SN": 2, "SP": 2})
    ...
    return finish_game(
        ...
        players,
        "G5: Betrayal",
        "SN+SP alliance, SP betrays SN on cycle 12 (assassin+saboteur)",
        TAGS_4,
    )
...
def game_06(token):
    ...
    return finish_game(
        ...
        admin,
        players,
        "G6: Counter-Intel Heavy",
        "V=CI every 2 cycles, SN=CI every 3 cycles, GR=no CI (all offense)",
        TAGS_4,
    )
...
def game_07(token):
    ...
    epoch_id, players, admin = setup_game(
        ctx, token, "G7: Diplomat Preset", config, TAGS_4, alliances={"Grand Alliance": ("V", "GR")}
    )
    last = run_foundation(ctx, epoch_id, players, admin, {"V": 2, "GR": 2, "SN": 2, "SP": 2})
    ...
    return finish_game(
        ...
        players,
        "G7: Diplomat Preset",
        "Diplomatic=30% weight, V+GR alliance, infiltrator-heavy",
        TAGS_4,
    )
...
def game_08(token):
    ...
    return finish_game(
        ...
        players,
        "G8: High RP Economy",
        "25 RP/cycle, 75 cap — tests multi-op per cycle with varied guardians",
        TAGS_4,
    )
...
def game_09(token):
    ...
    return finish_game(
        ...
        players,
        "G9: No Guardians",
        "Zero guardians — pure offense, higher success probabilities",
        TAGS_4,
    )
...
def game_10(token):
    ...
    return finish_game(
        ...
        players,
        "G10: Builder Preset",
        "Stability=40%, V+GR=3 guardians (builders), SN+SP=1 guardian (raiders)",
        TAGS_4,
    )
