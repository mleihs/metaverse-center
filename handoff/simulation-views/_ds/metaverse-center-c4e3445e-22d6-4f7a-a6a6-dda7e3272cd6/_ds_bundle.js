/* @ds-bundle: {"format":4,"namespace":"MetaverseCenter_c4e344","components":[{"name":"EpochChatApiServiceImpl","sourcePath":"src/services/api/EpochChatApiService.ts"},{"name":"EpochsApiService","sourcePath":"src/services/api/EpochsApiService.ts"},{"name":"PERSONALITY_COLORS","sourcePath":"src/utils/bot-colors.ts"},{"name":"DEFAULT_FOUNDATION_CYCLES","sourcePath":"src/utils/epoch.ts"},{"name":"DEFAULT_RECKONING_CYCLES","sourcePath":"src/utils/epoch.ts"},{"name":"OPERATIVE_COLORS","sourcePath":"src/utils/operative-constants.ts"},{"name":"OPERATIVE_SHORT","sourcePath":"src/utils/operative-constants.ts"},{"name":"OPERATIVE_LABEL","sourcePath":"src/utils/operative-constants.ts"},{"name":"OPERATIVE_FULL","sourcePath":"src/utils/operative-constants.ts"},{"name":"OPERATIVE_RP_COSTS","sourcePath":"src/utils/operative-constants.ts"},{"name":"SECURITY_LEVEL_MAP","sourcePath":"src/utils/operative-constants.ts"}],"sourceHashes":{"src/components/epoch/AcademyEpochCard.ts":"04830b1c66ee","src/components/epoch/BotConfigPanel.ts":"7303f20dafb6","src/components/epoch/DeployOperativeModal.ts":"7ab8aa7ba80a","src/components/epoch/DraftRosterPanel.ts":"6d7d82409e04","src/components/epoch/EpochAlliancesTab.ts":"05bacd361e38","src/components/epoch/EpochBattleLog.ts":"19258c3039ea","src/components/epoch/EpochChatPanel.ts":"0b1190709815","src/components/epoch/EpochCommandCenter.ts":"6590d156cf00","src/components/epoch/EpochCreationWizard.ts":"e99f299273b8","src/components/epoch/EpochIntelDossierTab.ts":"883481b5e825","src/components/epoch/EpochInviteAcceptView.ts":"0caa49229168","src/components/epoch/EpochInvitePanel.ts":"028be341b3b6","src/components/epoch/EpochLeaderboard.ts":"6dcf1ab347e3","src/components/epoch/EpochLobbyActions.ts":"4194dca510e6","src/components/epoch/EpochOperationsTab.ts":"0e4964fa5eef","src/components/epoch/EpochOpsBoard.ts":"2f8449072d6d","src/components/epoch/EpochOverviewTab.ts":"f11eaf6f8188","src/components/epoch/EpochPresenceIndicator.ts":"fcbd04e88d26","src/components/epoch/EpochReadyPanel.ts":"b084cca73edb","src/components/epoch/EpochResultsView.ts":"f95373a7efbb","src/components/epoch/MissionCard.ts":"810e89e83886","src/components/epoch/WarRoomPanel.ts":"92cddfa1aadf","src/components/epoch/deploy-operative-styles.ts":"b4ede369a790","src/components/shared/ConfirmDialog.ts":"f5cef3c89461","src/components/shared/Toast.ts":"1a29adff354b","src/components/shared/focus-trap.ts":"aab501a9d8e2","src/components/shared/form-styles.ts":"b8e10f6383b2","src/components/shared/info-bubble-styles.ts":"76971d5ad586","src/components/terminal/EpochTerminalView.ts":"7e52cc176819","src/services/api/EpochChatApiService.ts":"7d6842fa4af4","src/services/api/EpochsApiService.ts":"37b3fc884cc3","src/types/index.ts":"89b827f71c6f","src/types/terminal.ts":"cba2408cf37c","src/utils/bot-colors.ts":"15d3703dc087","src/utils/date-format.ts":"51ee4457a668","src/utils/epoch.ts":"e78f5bf02875","src/utils/icons.ts":"bb9c79e8842c","src/utils/operative-constants.ts":"36c4d6ec0119","src/utils/operative-icons.ts":"d96751f28540"},"inlinedExternals":[],"unexposedExports":[{"name":"computePhaseCycles","sourcePath":"src/utils/epoch.ts"},{"name":"computeTotalCycles","sourcePath":"src/utils/epoch.ts"},{"name":"deployOperativeStyles","sourcePath":"src/components/epoch/deploy-operative-styles.ts"},{"name":"epochChatApi","sourcePath":"src/services/api/EpochChatApiService.ts"},{"name":"epochsApi","sourcePath":"src/services/api/EpochsApiService.ts"},{"name":"focusFirstElement","sourcePath":"src/components/shared/focus-trap.ts"},{"name":"formStyles","sourcePath":"src/components/shared/form-styles.ts"},{"name":"formatDate","sourcePath":"src/utils/date-format.ts"},{"name":"formatDateFull","sourcePath":"src/utils/date-format.ts"},{"name":"formatDateLabel","sourcePath":"src/utils/date-format.ts"},{"name":"formatDateRange","sourcePath":"src/utils/date-format.ts"},{"name":"formatDateTime","sourcePath":"src/utils/date-format.ts"},{"name":"formatDateTimeShort","sourcePath":"src/utils/date-format.ts"},{"name":"formatElapsedMs","sourcePath":"src/utils/date-format.ts"},{"name":"formatRelativeTime","sourcePath":"src/utils/date-format.ts"},{"name":"formatRelativeTimeVerbose","sourcePath":"src/utils/date-format.ts"},{"name":"formatShortDateRange","sourcePath":"src/utils/date-format.ts"},{"name":"formatTime","sourcePath":"src/utils/date-format.ts"},{"name":"formatTimestamp","sourcePath":"src/utils/date-format.ts"},{"name":"getBattleEventIcon","sourcePath":"src/utils/operative-icons.ts"},{"name":"getDateLocale","sourcePath":"src/utils/date-format.ts"},{"name":"getOperativeIcon","sourcePath":"src/utils/operative-icons.ts"},{"name":"icons","sourcePath":"src/utils/icons.ts"},{"name":"infoBubbleStyles","sourcePath":"src/components/shared/info-bubble-styles.ts"},{"name":"numberInputStyles","sourcePath":"src/components/shared/form-styles.ts"},{"name":"renderInfoBubble","sourcePath":"src/components/shared/info-bubble-styles.ts"},{"name":"trapFocus","sourcePath":"src/components/shared/focus-trap.ts"}]} */

(() => {

const __ds_ns = (window.MetaverseCenter_c4e344 = window.MetaverseCenter_c4e344 || {});

const __ds_scope = {};

(__ds_ns.__errors = __ds_ns.__errors || []);

// src/components/epoch/deploy-operative-styles.ts
try { (() => {
const deployOperativeStyles = css`
		:host {
			display: block;
...
`;
Object.assign(__ds_scope, { deployOperativeStyles });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/components/epoch/deploy-operative-styles.ts", error: String((e && e.message) || e) }); }

// src/components/shared/focus-trap.ts
try { (() => {
/**
 ...
 */
function trapFocus(e, container, host) {
  if (!container) return;
  const focusable = [...container.querySelectorAll(FOCUSABLE_SELECTOR), ...(host.querySelectorAll(FOCUSABLE_SELECTOR) || [])];
 ...
 */
function focusFirstElement(shadowRoot) {
  requestAnimationFrame(() => {
    const focusable = shadowRoot?.querySelector(FOCUSABLE_SELECTOR);
    focusable?.focus();
  });
}
Object.assign(__ds_scope, { trapFocus, focusFirstElement });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/components/shared/focus-trap.ts", error: String((e && e.message) || e) }); }
...
`;
Object.assign(__ds_scope, { formStyles, numberInputStyles });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/components/shared/form-styles.ts", error: String((e && e.message) || e) }); }

// src/components/shared/info-bubble-styles.ts
try { (() => {
/**
 ...
 */
function renderInfoBubble(text, id) {
  return html`
...
`;
Object.assign(__ds_scope, { renderInfoBubble, infoBubbleStyles });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/components/shared/info-bubble-styles.ts", error: String((e && e.message) || e) }); }

// src/services/api/EpochChatApiService.ts
try { (() => {
/**
...
class EpochChatApiServiceImpl extends __ds_scope.BaseApiService {
  sendMessage(epochId, data) {
    return this.post(`/epochs/${epochId}/chat`, data);
  }
  listMessages(epochId, params) {
    const queryParams = {};
    if (params?.limit) queryParams.limit = String(params.limit);
    if (params?.before) queryParams.before = params.before;
    return this.get(`/epochs/${epochId}/chat`, queryParams);
  }
  listTeamMessages(epochId, teamId, params) {
    const queryParams = {};
    if (params?.limit) queryParams.limit = String(params.limit);
    if (params?.before) queryParams.before = params.before;
    return this.get(`/epochs/${epochId}/chat/team/${teamId}`, queryParams);
  }
  setReady(epochId, simulationId, ready) {
    return this.post(`/epochs/${epochId}/ready`, {
      simulation_id: simulationId,
      ready
    });
  }
  passCycle(epochId, simulationId) {
    return this.post(`/epochs/${epochId}/pass-cycle?simulation_id=${simulationId}`, {});
  }
}
const epochChatApi = new EpochChatApiServiceImpl();
Object.assign(__ds_scope, { EpochChatApiServiceImpl, epochChatApi });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/services/api/EpochChatApiService.ts", error: String((e && e.message) || e) }); }

// src/services/api/EpochsApiService.ts
try { (() => {
/**
 * API service for the competitive layer — epochs, operatives, scores, battle log.
 */

class EpochsApiService extends __ds_scope.BaseApiService {
  // ── Epochs ──────────────────────────────────────────
  ...
  /** See `listEpochs` for the mode convention. */
  listParticipants(epochId, mode) {
    return mode === 'public' ? this.getPublic(`/epochs/${epochId}/participants`) : this.get(`/epochs/${epochId}/participants`);
  }
  joinEpoch(epochId, simulationId) {
    return this.post(`/epochs/${epochId}/participants`, {
      simulation_id: simulationId
    });
  }
  leaveEpoch(epochId, simulationId) {
    return this.delete(`/epochs/${epochId}/participants/${simulationId}`);
  }
  draftAgents(epochId, simulationId, agentIds) {
  ...
  /** See `listEpochs` for the mode convention. */
  listTeams(epochId, mode) {
    return mode === 'public' ? this.getPublic(`/epochs/${epochId}/teams`) : this.get(`/epochs/${epochId}/teams`);
  }
  createTeam(epochId, simulationId, name) {
    return this.post(`/epochs/${epochId}/teams?simulation_id=${simulationId}`, {
      name
    });
  }
  joinTeam(epochId, teamId, simulationId) {
    return this.post(`/epochs/${epochId}/teams/${teamId}/join?simulation_id=${simulationId}`);
  }
  leaveTeam(epochId, simulationId) {
    return this.post(`/epochs/${epochId}/teams/leave?simulation_id=${simulationId}`);
  }

  // ── Alliance Proposals ─────────────────────────────

  listProposals(epochId) {
    return this.get(`/epochs/${epochId}/proposals`);
  }
  createProposal(epochId, simulationId, teamId) {
    return this.post(`/epochs/${epochId}/proposals?simulation_id=${simulationId}`, {
      team_id: teamId
    });
  }
  inviteToTeam(epochId, teamId, simulationId, targetSimulationId) {
    return this.post(`/epochs/${epochId}/teams/${teamId}/invite?simulation_id=${simulationId}`, {
      target_simulation_id: targetSimulationId
    });
  }
  voteOnProposal(epochId, proposalId, simulationId, vote) {
    return this.post(`/epochs/${epochId}/proposals/${proposalId}/vote?simulation_id=${simulationId}`, {
      vote
    });
  }
  ...
  listMissions(epochId, params) {
    return this.get(`/epochs/${epochId}/operatives`, params);
  }
  getMission(epochId, missionId) {
    return this.get(`/epochs/${epochId}/operatives/${missionId}`);
  }
  deployOperative(epochId, simulationId, data) {
    return this.post(`/epochs/${epochId}/operatives?simulation_id=${simulationId}`, data);
  }
  recallOperative(epochId, missionId, simulationId) {
    return this.post(`/epochs/${epochId}/operatives/${missionId}/recall?simulation_id=${simulationId}`);
  }
  listThreats(epochId, simulationId) {
    return this.get(`/epochs/${epochId}/operatives/threats`, {
      simulation_id: simulationId
    });
  }
  counterIntelSweep(epochId, simulationId) {
    return this.post(`/epochs/${epochId}/operatives/counter-intel?simulation_id=${simulationId}`);
  }
  fortifyZone(epochId, simulationId, zoneId) {
    return this.post(`/epochs/${epochId}/operatives/fortify-zone?simulation_id=${simulationId}&zone_id=${zoneId}`);
  }
   ...
   */
  getLeaderboard(epochId, mode, cycle) {
    const params = {};
    if (cycle !== undefined) params.cycle = String(cycle);
    return mode === 'public' ? this.getPublic(`/epochs/${epochId}/leaderboard`, params) : this.get(`/epochs/${epochId}/scores/leaderboard`, params);
  }

  /** See `getLeaderboard` — public and member use different paths. */
  getFinalStandings(epochId, mode) {
    return mode === 'public' ? this.getPublic(`/epochs/${epochId}/standings`) : this.get(`/epochs/${epochId}/scores/standings`);
  }
  getScoreHistory(epochId, simulationId) {
    return this.get(`/epochs/${epochId}/scores/simulations/${simulationId}`);
  }
  getResultsSummary(epochId) {
    return this.get(`/epochs/${epochId}/results-summary`);
  }
  getIntelDossiers(epochId, simulationId) {
    return this.get(`/epochs/${epochId}/scores/intel-dossiers?simulation_id=${simulationId}`);
  }

  // ── War Room ──────────────────────────────────────

  getCycleSummary(epochId, cycle, simulationId) {
    const params = {
      cycle: String(cycle)
    };
  ...
  getSitrep(epochId, cycleNumber, simulationId) {
    const params = {};
    if (simulationId) params.simulation_id = simulationId;
  ...
  /** See `listEpochs` for the mode convention. */
  getBattleLog(epochId, mode, params) {
    return mode === 'public' ? this.getPublic(`/epochs/${epochId}/battle-log`, params) : this.get(`/epochs/${epochId}/battle-log`, params);
  }
  getBattleLogPublic(epochId, params) {
    return this.getPublic(`/epochs/${epochId}/battle-log`, params);
  }

  // ── Invitations ────────────────────────────────────

  sendInvitation(epochId, data) {
    return this.post(`/epochs/${epochId}/invitations`, data);
  }
  listInvitations(epochId) {
    return this.get(`/epochs/${epochId}/invitations`);
  }
  revokeInvitation(epochId, invitationId) {
    return this.delete(`/epochs/${epochId}/invitations/${invitationId}`);
  }
  regenerateLore(epochId) {
    return this.post(`/epochs/${epochId}/invitations/regenerate-lore`);
  }
  validateEpochInvitation(token) {
    return this.getPublic(`/epoch-invitations/${token}`);
  }
}
const epochsApi = new EpochsApiService();
Object.assign(__ds_scope, { EpochsApiService, epochsApi });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/services/api/EpochsApiService.ts", error: String((e && e.message) || e) }); }

// src/utils/bot-colors.ts
try { (() => {
/**
...
Object.assign(__ds_scope, { PERSONALITY_COLORS });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/utils/bot-colors.ts", error: String((e && e.message) || e) }); }
...
function getDateLocale() {
  return __ds_scope.localeService.currentLocale === 'de' ? 'de-DE' : 'en-GB';
}
...
function formatDate(dateStr, options) {
  ...
  try {
    ...
    __ds_scope.captureError(err, {
      source: 'date-format.formatDate'
    });
...
function formatDateTime(dateStr, options) {
  ...
  try {
    ...
    __ds_scope.captureError(err, {
      source: 'date-format.formatDateTime'
    });
    return fallback || dateStr;
  }
}
 ...
 */
function formatDateTimeShort(dateStr, options) {
  const fallback = options?.fallback ?? '';
  if (!dateStr) return fallback;
  try {
    return new Date(dateStr).toLocaleDateString(options?.locale, {
    ...
    __ds_scope.captureError(err, {
      source: 'date-format.formatDateTimeShort'
    });
    return fallback || dateStr;
  }
}
 ...
 */
function formatDateFull(dateStr, options) {
  const fallback = options?.fallback ?? '';
  if (!dateStr) return fallback;
  try {
    return new Date(dateStr).toLocaleDateString(options?.locale, {
    ...
    __ds_scope.captureError(err, {
      source: 'date-format.formatDateFull'
    });
    return fallback || dateStr;
  }
}
 ...
 */
function formatRelativeTime(dateStr, options) {
  if (!dateStr) return '';
  try {
    ...
    __ds_scope.captureError(err, {
      source: 'date-format.formatRelativeTime'
    });
    return '';
  }
}
 ...
 */
function formatRelativeTimeVerbose(dateStr, options) {
  if (!dateStr) return '';
  try {
    const date = new Date(dateStr);
    const now = new Date();
    ...
    __ds_scope.captureError(err, {
      source: 'date-format.formatRelativeTimeVerbose'
    });
    return '';
  }
}
...
function formatDateLabel(dateStr) {
  try {
    ...
    __ds_scope.captureError(err, {
      source: 'date-format.formatDateLabel'
    });
    return '';
  }
}
 ...
 * Uses en-dash (\u2013) as separator.
 */
function formatShortDateRange(start, end, options) {
  const locale = options?.locale;
  const o = {
    month: 'short',
    day: 'numeric'
...
Object.assign(__ds_scope, { getDateLocale, formatDate, formatDateTime, formatDateTimeShort, formatDateFull, formatTime, formatTimestamp, formatRelativeTime, formatRelativeTimeVerbose, formatDateLabel, formatDateRange, formatShortDateRange, formatElapsedMs });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/utils/date-format.ts", error: String((e && e.message) || e) }); }
...
const DEFAULT_FOUNDATION_CYCLES = 4;
const DEFAULT_RECKONING_CYCLES = 8;
/** Compute the total number of cycles for an epoch config. */
function computeTotalCycles(config) {
 ...
 */
function computePhaseCycles(config) {
...
Object.assign(__ds_scope, { DEFAULT_FOUNDATION_CYCLES, DEFAULT_RECKONING_CYCLES, computeTotalCycles, computePhaseCycles });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/utils/epoch.ts", error: String((e && e.message) || e) }); }
...
const icons = {
  ...
  resonanceArchetype: (signature, size = 16) => {
    const map = {
  ...
  `,
  /** External link (open-in-new) — Platform Chrome Tier 1. Tabler-derived. */
  externalLink: (size = 14) => svg`
    <svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" aria-hidden="true"
      fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="square" stroke-linejoin="miter">
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/utils/icons.ts", error: String((e && e.message) || e) }); }

// src/utils/operative-constants.ts
try { (() => {
/**
...
Object.assign(__ds_scope, { OPERATIVE_COLORS, OPERATIVE_SHORT, OPERATIVE_LABEL, OPERATIVE_FULL, OPERATIVE_RP_COSTS, SECURITY_LEVEL_MAP });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/utils/operative-constants.ts", error: String((e && e.message) || e) }); }

// src/utils/operative-icons.ts
try { (() => {
/**
...
const OPERATIVE_ICON_MAP = {
  spy: __ds_scope.icons.operativeSpy,
  saboteur: __ds_scope.icons.operativeSaboteur,
  propagandist: __ds_scope.icons.megaphone,
  assassin: __ds_scope.icons.operativeAssassin,
  infiltrator: __ds_scope.icons.operativeInfiltrator,
  guardian: __ds_scope.icons.operativeGuardian
};
const BATTLE_EVENT_ICON_MAP = {
  operative_deployed: __ds_scope.icons.target,
  mission_success: __ds_scope.icons.checkCircle,
  mission_failed: __ds_scope.icons.xCircle,
  detected: __ds_scope.icons.alertTriangle,
  sabotage: __ds_scope.icons.explosion,
  propaganda: __ds_scope.icons.megaphone,
  assassination: __ds_scope.icons.operativeAssassin,
  agent_wounded: __ds_scope.icons.droplet,
  alliance_formed: __ds_scope.icons.handshake,
  alliance_proposal: __ds_scope.icons.handshake,
  alliance_proposal_accepted: __ds_scope.icons.checkCircle,
  alliance_proposal_rejected: __ds_scope.icons.xCircle,
  alliance_tension_increase: __ds_scope.icons.alertTriangle,
  alliance_dissolved_tension: __ds_scope.icons.skull,
  alliance_upkeep: __ds_scope.icons.gear,
  betrayal: __ds_scope.icons.skull,
  phase_change: __ds_scope.icons.bolt,
  counter_intel: __ds_scope.icons.radar,
  intel_report: __ds_scope.icons.clipboard,
  zone_fortified: __ds_scope.icons.operativeGuardian,
  player_passed: __ds_scope.icons.timer,
  cycle_resolved: __ds_scope.icons.bolt,
  cycle_auto_resolved: __ds_scope.icons.timer,
  player_afk: __ds_scope.icons.timer,
  player_afk_penalty: __ds_scope.icons.alertTriangle,
  player_afk_ai_takeover: __ds_scope.icons.brain
};

/** Get SVG icon for an operative type. */
function getOperativeIcon(type, size = 16) {
  const fn = OPERATIVE_ICON_MAP[type];
  return fn ? fn(size) : __ds_scope.icons.crossedSwords(size);
}

/** Get SVG icon for a battle log event type. */
function getBattleEventIcon(type, size = 16) {
  const fn = BATTLE_EVENT_ICON_MAP[type];
  return fn ? fn(size) : __ds_scope.icons.crossedSwords(size);
}
Object.assign(__ds_scope, { getOperativeIcon, getBattleEventIcon });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/utils/operative-icons.ts", error: String((e && e.message) || e) }); }

__ds_ns.EpochChatApiServiceImpl = __ds_scope.EpochChatApiServiceImpl;

__ds_ns.EpochsApiService = __ds_scope.EpochsApiService;

__ds_ns.PERSONALITY_COLORS = __ds_scope.PERSONALITY_COLORS;

__ds_ns.DEFAULT_FOUNDATION_CYCLES = __ds_scope.DEFAULT_FOUNDATION_CYCLES;

__ds_ns.DEFAULT_RECKONING_CYCLES = __ds_scope.DEFAULT_RECKONING_CYCLES;

__ds_ns.OPERATIVE_COLORS = __ds_scope.OPERATIVE_COLORS;

__ds_ns.OPERATIVE_SHORT = __ds_scope.OPERATIVE_SHORT;

__ds_ns.OPERATIVE_LABEL = __ds_scope.OPERATIVE_LABEL;

__ds_ns.OPERATIVE_FULL = __ds_scope.OPERATIVE_FULL;

__ds_ns.OPERATIVE_RP_COSTS = __ds_scope.OPERATIVE_RP_COSTS;

__ds_ns.SECURITY_LEVEL_MAP = __ds_scope.SECURITY_LEVEL_MAP;
